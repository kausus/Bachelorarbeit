...
\begin{proof}
	\todo{vorschlag: soll hier der beweis für M=M, N=R3}
\end{proof}
...
\begin{Satz}
	...
	\begin{proof}
		...
		entsteht und die Spinstruktur erhalten bleibt.
		 \todo{zeige die wohldef, und glueing eigenschaften}
	\end{proof}
\end{Satz}
...
\begin{Satz}
	...
	\begin{proof}
          ...
          ist gegeben durch den Pullback des Diagramms $  $
              \begin{center}
              \begin{tikzcd}
                \Ph{\spin_2}{M} \arrow[r] \arrow[d] \arrow[dr, phantom, "\ulcorner", very near start] & \spin_3 \arrow[d,"2:1"] \\
