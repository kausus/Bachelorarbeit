...
glatten Weg verbinden lassen.
 ...
 Das folgende Theorem liefert uns eine erste Vereinfachung des Raumes. \todo{Quelle}
...
%	\end{gather*}
	...
	keine Homotopieäquivalenz. \todo{beispiel finden}
\end{Bsp}
...
\begin{Satz}
  ...
  \end{gather*}
  \todo{was meint hier S1 invariant.}
  \begin{proof}
    ...
    \item[Surjektivität:] Sei eine $\S^1$-invariante Abbildung
      ...
      $\abb{F_p}{\tang{p}{M}}{\R^3}$ durch \todo{frac und norm
        vertragen sich nicht} $v \mapsto \begin{cases}
        w(\frac{v}{\norm{v}}) & v \neq 0 \\
        0 & v=0.
      \end{cases}$
	...
	\begin{proof}
		\begin{description}
                ...
                \item[2. Schritt;] Seien nun die obigen Identitäten
                  \ref{id1} \todo{cref verwenden} gegeben, um nun die
...
\begin{Satz}
	...
	\begin{center}
		\begin{tikzcd}
			\set{ \abb{H}{\S M}{\so_3}}{H\text{ ist }\S^1 \text{-invariant}}  \arrow[rr,"\psi"] && \sset{\text{Spinstrukturen auf }M}.\\
		\end{tikzcd}
	\end{center}
	\begin{proof}
          ...
          \item[$1$-Skelett:] Für diesen Fall ist nun die Abbildung
            ...
            \begin{center}
              \begin{tikzcd}
                && \spin_3 \arrow[dd,"2:1 u \mapsto \pair{a}{u}"] \\
                &&\\
