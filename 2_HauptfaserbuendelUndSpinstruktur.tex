    ...
    \begin{smallproof}(Nachweis das dies ein Hauptfaserbündel ist) Die
      ...
      dies ein Hauptfaserbündel mit Strukturgruppe $G$.
		...
		\begin{smallproof}
                  ...
                  Atlas von $M$.  \todo{Angabe eines Atlas für
                    $\GL(M)$}
                  ...
                  lassen. Die Eigenschaft frei wollt auch aus der
                  Eigenschaft von Basistransformationen. Die
...
\begin{Bsp}
  ...
  \item Das erste Beispiel ist das Triviale. Für die \RMF
    ...
    \todo{falscher Name} $ \Ph{\so_n}{M} $ für eine Mannigfaltigkeit
...
%			\end{center}	
      \begin{center}
        ...
        \begin{tikzcd}
          \spin_n \ar[rr, "a \mapsto \pair{p}{au}"] \ar[dd, "\Ad"'] & &  \R^n\times \spin_n  \arrow[rd] \arrow[dd, "\pi_1"] & \\
          &&& \R^n \\
          \so_n \arrow[rr , "A \mapsto pA"] & & \R^n \arrow[ru] &
        \end{tikzcd}
      \end{center}
  ...
  \item Ein erstes nichttriviales Beispiel sind zwei nicht isomorphie
    ...
    Spinstrukturen bis auf Isomorphie.  \todo{suche verweis auf
      hijazi}
  ...
  \item Ein wichtiges Beispiel für eine \RMF mit deren Spinstruktur
    ...
    Isomorphie.  \todo{angabe dieser spinstruktur} \todo{Angabe von
      Spinstrukturen auf S1 und Torus,alle vier Spinstrukturen?}
	\end{enumerate}
\end{Bsp}
