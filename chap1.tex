...
\begin{Bsp}
	\begin{enumerate}[1)]
		...
		%TODO:  beispiel der zweifache Überlagerung der S^1
...
%TODO: angabe dieser spinstruktur
	\end{enumerate}
\end{Bsp}
...
%TODO: bilder der beiden Immersionen
...
\begin{Satz}
	...
	\begin{proof}
		...
		%TODO: warum liefert sie das, genauer.
	\end{proof}
\end{Satz}
...
%TODO: bijektion oder homotopieäquivelante räume?
	\begin{align*}
...
\begin{center}
\begin{tikzcd}
	\set{ (\abb{F_p}{\T_pM}{\R^3})_{p\in M} }{\text{ isometrisch}} \arrow[rr,"\vartheta"] && \set{ \abb{H}{\Sp M}{\so{3}}}{\Sp^1 \text{-invariant}} \\
\end{tikzcd}
\end{center}
\begin{proof}
	...
	\begin{description}
		...
		$v \mapsto \begin{cases}%TODO: frac und norm vertragen sich nicht
		w(\frac{v}{\norm{v}}) & v \neq 0 \\
		0 & v=0.
		\end{cases}$
